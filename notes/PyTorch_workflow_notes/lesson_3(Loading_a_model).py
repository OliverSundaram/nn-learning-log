...
model_0.load_state_dict(torch.load(f="models_state_dict/model_0_2_input_0_hidden_1_output.pth"))
...
optimizer = torch.optim.SGD(params=model_0.parameters(),
                            lr=0.000001) # Learning rate - how big or small the optimizer changes the parameters
