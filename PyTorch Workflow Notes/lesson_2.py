...
# 3. Train model
# Moving the random parameters to parameters that better represent the data
...
optimizer = torch.optim.SGD(params=model_0.parameters(), # The models parameters that you would like to optimize
...
# 1. Forward pass (This involves data moving through the model's forward()) to
#    make predictions on data - also called forward propagation
